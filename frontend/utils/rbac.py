...
MATRIZ_ACESSO: dict[str, set[str]] = {
    ...
    "gestor": {
        ...
        "credito_verde", "esg_dashboard", "notas_fiscais", "nfce_offline"
    },
    "financeiro": {"painel", "notas_fiscais", "nfce_offline", "auditoria", "esg_dashboard"},
    "operador": {"painel", "credito_verde", "nfce_offline"}
}
